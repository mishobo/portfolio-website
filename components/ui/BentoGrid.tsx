...
export const BentoGridItem = ({
  ...
  const handleCopy = () => {
    navigator.clipboard.writeText('husseinabdallah287@gmail.com')
    setCopied(true);
  }
      ...
      <div className={`${id === 6 && 'flex justify-center'} h-full`} >
        ...
        {id === 3 && (
          <div className="flex gap-1 lg:gap-5 w-fit absolute -right-3 lg:-right-2">
            ...
            <span className="py-4 px-3 text-xs lg:text-base opacity-50 lg:opacity-100 rounded-lg text-center bg-[#10132e]" />
            </div>

            <div className="flex flex-col gap-3 lg:gap-8">
            <span className="py-4 px-3 text-xs lg:text-base opacity-50 lg:opacity-100 rounded-lg text-center bg-[#10132e]" />
              {['Java', 'Kotlin', 'Spring Boot'].map((item) => 
              <span className="lg:py-4 lg:px-3 py-2 px-3 text-xs lg:text-base opacity-50 
                    lg:opacity-100 rounded-lg text-center bg-[#10132E]">
                {item}
              </span>
