...
const Hero = () => {
  return (
    <div className='pb-20 pt-36'>
        ...
        dark:bg-grid-white/[0.05] bg-grid-black/[0.2] flex items-center justify-center
        ...
        <div className='flex justify-center relative my-20 z-10'>
            <div className='max-w-[89vw] md:max-w-2xv
            lg:max-w-[60vw] flex flex-col items-center justify-center'>
                ...
                words='Hello, I&apos;am Hussein Abdallah, a Software Engineer' />

                <p className='text-center md:tracking-wider mb-4 text-sm md:text-lg lg:text-2xl'>
                    Hi, I&apos;am Mishobo, a full stack web developer based in Kenya 
                </p>
